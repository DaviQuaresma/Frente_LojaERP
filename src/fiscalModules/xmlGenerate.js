...
module.exports = function gerarXmlNfe(dados) {
	...
	if (dados.ide.tpEmis === "9") {
		ide
			.ele("dhCont").txt(dados.ide.dhCont).up()
	...
	// ) {
	// 	const infNFeSupl = doc.ele("infNFeSupl");
	// 	infNFeSupl.ele("qrCode").txt(dados.suplementar.qrCode).up();
	// 	infNFeSupl.ele("urlChave").txt(dados.suplementar.urlChave).up();
	// }
